        ...
        <div className="min-h-screen pt-28 pb-16 bg-white">
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-3xl mx-auto">
              <Link href="/#blog">
                <a className="inline-flex items-center text-primary hover:text-primary-dark mb-8">
              ...
              <div className="text-center py-12">
                ...
                <Link href="/#blog">
                  <a className="inline-block bg-primary hover:bg-primary-dark text-white font-medium py-3 px-8 rounded-md transition-colors">
                    Return to Blog
                  </a>
                </Link>
              </div>
