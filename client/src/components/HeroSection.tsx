    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex items-center relative z-10">
        <div className="max-w-2xl text-white">
          ...
          <div className="bg-secondary/90 text-white p-4 rounded-lg mb-8 shadow-lg transform hover:scale-105 transition duration-300">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-bold text-lg">Price Match Guarantee</p>
                <p>We'll beat any competitor's price. No questions asked!</p>
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-16 left-0 right-0 mx-auto max-w-5xl px-4">
        <div className="bg-black/50 backdrop-blur-sm p-4 rounded-lg flex justify-center items-center gap-6 flex-wrap">
