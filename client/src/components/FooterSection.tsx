      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-4 pt-4 border-t border-white/10 text-center flex justify-between items-center flex-col md:flex-row">
          ...
          <div className="flex space-x-4 mt-2 md:mt-0 text-sm">
            <a href="#" className="text-white hover:text-secondary transition duration-300">Privacy Policy</a>
            <a href="#" className="text-white hover:text-secondary transition duration-300">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
